...
# select red and white
y = df.iloc[0:100, 4].values
y = np.where(y == 'Wine', -1, 1)

# extract Acidez and Dioxido de azufre
...
plt.scatter(X[50:100, 0], X[50:100, 1],
            color='blue', marker='x', label='white')
...
plt.xlabel('Acidez [standardized]')
plt.ylabel('Dioxido de azufre [standardized]')
plt.legend(loc='upper left')
